...
import { getPinnedAddonIds, getRegisteredAddons } from "../components/addons/settingsController.js";
import {
...
export function syncSettingsSidebarNavigation(shadowRoot) {
...
export function initSettingsSidebarNavigation(shadowRoot) {
