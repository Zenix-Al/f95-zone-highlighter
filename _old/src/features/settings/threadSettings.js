...
import { injectImageRepair } from "../../core/imageHandler";
import { updateThreadUI } from "../../core/init";
import { checkOverlaySettings } from "../../core/safety";
import { signatureCollapse } from "../../core/thread";
import { toggleDirectDownloadHijack } from "../hijackDownloadLink";
import { toggleMsgEventHandler } from "../msgHandler";
import { toggleHijackMaskedLink } from "../maskedLinkSkipper";
import { queuedProcessThreadTags } from "../../core/tasksRegistry";
import { wideForum } from "../../core/ui/wideForum";
