...
| thread-utility-addon | 36 | 14 | 2 | 0 | 0 | addon.access (1), config.getTagPrefs (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.dialog.close (1), ui.dialog.open (1), ui.dialog.update (1), ui.mount (1), ui.style.register (1), ui.style.unregister (1), ui.unmount (1), ui.update (1) |
