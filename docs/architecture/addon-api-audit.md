...
|---|---:|---:|---:|---:|---:|---|
| site-repair-addon | 17 | 8 | 0 | 2 | 0 | addon.access (1), observer.unwatch (1), observer.watch (1), page.getContext (1), storage.get (1), storage.set (1), ui.style.register (1), ui.style.unregister (1) |
| masked-direct-addon | 30 | 7 | 5 | 13 | 57 | observer.waitFor (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.style.register (1), ui.style.unregister (1) |
| library-addon | 56 | 27 | 1 | 7 | 0 | addon.access (1), addon.throttle (1), config.getTagPrefs (2), idb.bulkPut (1), idb.delete (1), idb.get (1), idb.put (2), idb.query (1), observer.waitFor (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.confirm (1), ui.dialog.close (2), ui.dialog.open (2), ui.dialog.update (1), ui.mount (1), ui.style.register (2), ui.style.unregister (2), ui.unmount (1) |
