...
| latest-filters-addon | 25 | 14 | 2 | 2 | 0 | config.getTagPrefs (1), observer.waitFor (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.confirm (1), ui.dialog.close (1), ui.dialog.open (1), ui.dialog.update (1), ui.mount (1), ui.style.register (1), ui.style.unregister (1), ui.unmount (1) |
