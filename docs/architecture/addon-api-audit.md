...
| masked-direct-addon | 50 | 9 | 6 | 16 | 102 | observer.unwatch (1), observer.waitFor (1), observer.watch (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.style.register (1), ui.style.unregister (1) |
| library-addon | 92 | 47 | 2 | 13 | 0 | addon.access (1), addon.throttle (1), config.getTagPrefs (2), idb.bulkPut (2), idb.count (2), idb.delete (4), idb.get (5), idb.put (6), idb.query (7), observer.waitFor (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.confirm (1), ui.dialog.close (2), ui.dialog.open (2), ui.dialog.update (1), ui.mount (1), ui.style.register (2), ui.style.unregister (2), ui.unmount (1) |
