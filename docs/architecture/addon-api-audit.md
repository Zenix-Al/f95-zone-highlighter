...
7 of 7 manifest add-ons were inventoried. All raw action occurrences are mapped to the current descriptor list or the existing `addon.access` / `addon.throttle` management calls.
...
| masked-direct-addon | 58 | 9 | 5 | 15 | 112 | observer.unwatch (1), observer.waitFor (1), observer.watch (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.style.register (1), ui.style.unregister (1) |
| library-addon | 100 | 55 | 2 | 14 | 0 | addon.access (1), addon.throttle (1), config.getTagPrefs (2), idb.bulkDelete (1), idb.bulkPut (3), idb.count (3), idb.delete (5), idb.get (6), idb.put (7), idb.query (8), observer.waitFor (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.confirm (2), ui.dialog.close (2), ui.dialog.open (2), ui.dialog.update (1), ui.mount (1), ui.style.register (2), ui.style.unregister (2), ui.unmount (1) |
...
| latest-filters-addon | 30 | 14 | 3 | 4 | 0 | config.getTagPrefs (1), observer.waitFor (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.confirm (1), ui.dialog.close (1), ui.dialog.open (1), ui.dialog.update (1), ui.mount (1), ui.style.register (1), ui.style.unregister (1), ui.unmount (1) |
| halloween-theme-addon | 9 | 0 | 0 | 1 | 0 | none |
| thread-utility-addon | 38 | 16 | 2 | 0 | 0 | addon.access (1), config.getTagPrefs (1), page.getContext (1), storage.get (1), storage.set (1), toast.show (1), ui.dialog.close (1), ui.dialog.open (1), ui.dialog.update (1), ui.dock.removeButtons (1), ui.dock.setButtons (1), ui.mount (1), ui.style.register (1), ui.style.unregister (1), ui.unmount (1), ui.update (1) |
