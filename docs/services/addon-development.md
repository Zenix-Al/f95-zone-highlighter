...
This guide explains how to design, structure, and write an external F95UE Add-on. It serves as a detailed reference for the APIs exposed by the Core message bridge and is designed to supplement the high-level outline in [addons/README.md](file:///D:/programming/js/userscript/latest%20highlighter/addons/README.md).
