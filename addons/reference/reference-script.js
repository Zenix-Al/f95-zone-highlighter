...
(async function () {
  ...
  function getSaverSect() {
    ...
    let btnList = [
      createBtn("Load", loadAsyncEvent, ["fas", "fa-upload"]),
      createBtn("Save", saveEvent, ["fas", "fa-save"]),
    ];
    btnList.push(
      ...createBtns([storageKeys.A, storageKeys.B, storageKeys.C, storageKeys.D], slotSelectEvent, [
        "fas",
        "fa-compact-disc",
      ]),
    );
