...
export const LIBRARY_SCHEMA_MARKER_KEY = "schema-v4-complete";
...
export const LIBRARY_MINIMUM_BRIDGE_VERSION = "1.2.2";
...
export const LIBRARY_DB_STORES = [
  ...
  },
  {
    ...
    indexes: [
      { name: "cycleId", keyPath: "cycleId" },
      {
        name: "cycleStatusPosition",
        keyPath: ["cycleId", "status", "position"],
      },
      {
        name: "cycleNextAttempt",
        keyPath: ["cycleId", "nextAttemptAt"],
      },
      {
        name: "cycleStatusNextAttempt",
        keyPath: ["cycleId", "status", "nextAttemptAt"],
      },
    ],
  },
];
