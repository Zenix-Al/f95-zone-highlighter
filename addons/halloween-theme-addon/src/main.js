...
import { updateAddonRuntimeStatus, waitForCorePing } from "./api/bridge.js";
import { createCoreAdaptor } from "./core/adaptor.js";
import { createHalloweenThemeApp } from "./app/createHalloweenThemeApp.js";
...
const app = createHalloweenThemeApp({ core, runtime });
